...
DELETE FROM `testdb`.`Departments`;
DELETE FROM `testdb`.`Companies`;

ALTER TABLE `Users` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`Users`;
ALTER TABLE `Addresses` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`Addresses`;
ALTER TABLE `InvoiceLines` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`InvoiceLines`;
ALTER TABLE `Invoices` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`Invoices`;
ALTER TABLE `Countries` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`Countries`;
ALTER TABLE `Customers` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`Customers`;
ALTER TABLE `Suppliers` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`Suppliers`;

ALTER TABLE `EllipsesKit` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`EllipsesKit`;
DELETE FROM `testdb`.`Circles`;
DELETE FROM `testdb`.`Ellipses`;
DELETE FROM `testdb`.`Curved`;
DELETE FROM `testdb`.`Polygons`;
ALTER TABLE `Shapes` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`Shapes`;
ALTER TABLE `ShapesTPH` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`ShapesTPH`;
ALTER TABLE `ShapeOptions` AUTO_INCREMENT = 1;
DELETE FROM `testdb`.`ShapeOptions`;

DELETE FROM `testdb`.`BlackList`;


INSERT INTO `testdb`.`Customers` (`CUS_Id`, `CUS_FirstName`, `CUS_LastName`, `CUS_Email`, `CUS_TaxCode`, `CUS_IsActive`, `CUS_BirthDate`, `CUS_DeathDate`, `CUS_Points`, `CUS_CreationDate`) VALUES 
...
INSERT INTO `testdb`.`Countries` (`COU_Id`, `COU_Name`) VALUES 
...
INSERT INTO `testdb`.`Addresses` (`ADR_Id`, `ADR_Street`, `ADR_PostalCode`, `ADR_City`, `ADR_IsMain`, `COU_Id`, `CUS_Id`) VALUES 
...
INSERT INTO `testdb`.`Invoices` (`INV_Id`, `INV_Number`, `INV_Date`, `INV_IsPaid`, `CUS_Id`) VALUES 
...
INSERT INTO `testdb`.`InvoiceLines` (`ILI_Id`, `ILI_Concept`, `ILI_Amount`, `INV_Id`) VALUES 
...
INSERT INTO `testdb`.`ShapeOptions` (`SHO_Id`, `SHO_BackgroundColor`, `SHO_OutlineColor`) VALUES 
...
INSERT INTO `testdb`.`Shapes` (`SHA_Id`, `SHA_Name`, `SHO_Id`) VALUES 
...
INSERT INTO `testdb`.`Polygons` (`POL_Id`, `POL_Angle`, `POL_Length`) VALUES 
...
INSERT INTO `testdb`.`Curved` (`CUR_Id`, `CUR_Radius`) VALUES 
...
INSERT INTO `testdb`.`Circles` (`CIR_Id`) VALUES 
...
INSERT INTO `testdb`.`Ellipses` (`ELL_Id`, `ELL_Radius2`) VALUES 
...
INSERT INTO `testdb`.`EllipsesKit` (`ELK_Id`, `ELK_Name`, `ELL_Id1`, `ELL_Id2`, `ELL_Id3`) VALUES 
...
INSERT `testdb`.`Companies` (`COM_Id`, `COM_Name`, `COM_Logo`) VALUES ('1fda7e77-3b2e-4a13-b7c5-bb0b954c0554', 'Meejo', );


INSERT INTO `testdb`.`Departments` (`DEP_Id`, `DEP_Name`, `COM_Id`) VALUES 
...
INSERT INTO `testdb`.`Employees` (`EMP_Id`, `EMP_FullName`, `EMP_Email`, `EMP_PhoneNumber`, `DEP_Id`) VALUES 
...
INSERT INTO `testdb`.`Suppliers` (`SUP_Id`, `SUP_Name`, `SUP_Email`, `SUP_TaxCode`) VALUES 
...
INSERT INTO `testdb`.`Users` (`USR_Id`, `USR_FullName`, `USR_Username`, `USR_Settings`, `USR_IsActive`) VALUES 
...
INSERT INTO `testdb`.`BlackList` (`BLL_Year`, `BLL_Email`, `BLL_Amount`) VALUES 
